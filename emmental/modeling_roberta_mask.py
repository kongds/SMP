...
from emmental.modeling_bert_masked import BertEncoder
...
class MaskedRobertaEmbeddings(nn.Module):
    """
...
class MaskedRobertaPreTrainedModel(PreTrainedModel):
    """
...
class MaskedRobertaModel(MaskedRobertaPreTrainedModel):
    """
    ...
    def __init__(self, config, add_pooling_layer=True):
        ...
        self.embeddings = MaskedRobertaEmbeddings(config)
